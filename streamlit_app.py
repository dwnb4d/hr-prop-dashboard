...
st.write("Starter version for model probability, fair odds, book odds, edge, and score.")

data = [
    {"Player": "Example Batter", "Team": "SD", "Model%": 0.18, "Book Odds": +450, "Checkmarks": 9},
    {"Player": "Sample Slugger", "Team": "LAD", "Model%": 0.24, "Book Odds": +320, "Checkmarks": 11},
]
